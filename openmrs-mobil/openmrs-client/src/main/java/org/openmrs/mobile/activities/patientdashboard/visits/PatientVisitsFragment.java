...
public class PatientVisitsFragment extends PatientDashboardFragment implements PatientDashboardContract.ViewPatientVisits {
    ...
    @Override
    public void setVisitsToDisplay(List<Encounter> visits, List<Encountercreate> encountercreates) {
        PatientVisitsRecyclerViewAdapter adapter = new PatientVisitsRecyclerViewAdapter(this, visits,encountercreates);
