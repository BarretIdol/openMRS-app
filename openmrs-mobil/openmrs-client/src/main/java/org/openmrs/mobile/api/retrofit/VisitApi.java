...
public class VisitApi {
    ...
    public void createVisitProva(final Patient patient, @Nullable final StartVisitResponseListenerCallback callbackListener, Visit visita) {
            final Visit visit = new Visit();
            visit.setStartDatetime(visita.getStartDatetime());
            visit.setPatient(visita.getPatient());
            visit.setLocation(visita.getLocation());
            visit.setVisitType(visita.getVisitType());
